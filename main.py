...
userName = 'haley_nguyen1810@yahoo.com'
password = 'Vananh1810'
...
def req():
    ...
    try:
        ...
        print('Sorry wrong Usernam or Password')
    ...
    response = requests.post('https://api.fitbit.com/oauth2/delegate/token', headers=headers, data=data, verify=False)
    ...
    response = requests.post('https://web-api.fitbit.com/1/user/-/legacy/export/request-export.json', headers=headers,
    ...
    try:
        ...
        print('something wrong with downloading we will fix it soon')
        

#modify the csv
def filter():
    
    with open("venv/fitbit_export_20221003 (3).csv", "r") as f:
        data = f.read().split("\n")

    if data[0] =='Activity':
        del data[0]
        with open("venv/fitbit_export_20221003 (3).csv", "w") as f:
            f.write("\n".join(data))
    else:
        pass
        df = pd.read_csv('/Users/fengyiwei/Desktop/IT/IT S4/websit programming/WDPTutorials/fitbit_export_20221003 (3).csv')
        try:
            ...
            pass
        df.to_csv('/Users/fengyiwei/Desktop/IT/IT S4/websit programming/WDPTutorials/fitbit_export_20221003 (3).csv')
        print(df)
